...
| About                  | About link available to all users, when user clicks on about they should be redirected to about page      | Click on about  | User is redirected to the about page      |   Pass   |
...
| Feature | Expect | Action | Result | Pass/Fail |
|---------|--------|--------|--------|-----------|
|      Sidebar   |    Sidebar containing categories and popular posts is available to users on screens > 992px   |  Use Chrome developer tools to verify side bar is available on screens >= 992px and not on screens < 992px        |  side bar is available on screens >= 992px and not on screens < 992px       |  Pass         |
...
| Feature | Expect | Action | Result | Pass/Fail |
|---------|--------|--------|--------|-----------|
|  Posts per page on home page      |  There should be 4 posts per page      |  Open home page and count posts      |   There are 4 posts per page     |      Pass     |
...
| Un-like post | The heart icon should be solid red and available to click, turns from solid red to normal icon when clicked and likes counter decrements by 1      |  Click on heart icon      |    Heart icon turns from solid red to normal icon when clicked and likes counter decrements by 1  |    Pass       |
...
|     Leave a comment     |   Comment form should be present but does not accept text, the "Submit" button should not be present     |  Attempt to type in comment form    |    User can not type comment, and "Submit" button is not present |   Pass    |
|   All-posts button      |   When  user click on "All Posts" it should redirect them to the home page     |  Click on "All Posts"      |   User is redirected to the home page     | Pass           |
</details>
...
| Feature | Expect | Action | Result | Pass/Fail |
|---------|--------|--------|--------|-----------|
|    Submit signup form     |    Signup form is submitted, A message indicating success should appear and disappear automatically after 3 seconds    |     Click sign up link in navbar, fill in fields and click "submit"   |  Signup form was submitted, message appears and disappear automatically after 3 seconds![Register](/static/images/success-messages/success-register.PNG)        |     Pass      |
|     Submit without filling out fields    |    The user should get an error message: "Please fill out this field"    |   Click "Sign-up" without filling in the mandatory fields      |   The user gets an error message: "Please fill out this field"    |    Pass       |
|         |        |        |        |           |
</details>
